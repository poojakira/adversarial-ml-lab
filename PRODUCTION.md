...
This repository is maintained as a **adversarial ML robustness evaluation service/toolkit**.

## Production purpose

execute bounded attacks and defenses against configured models with reproducible evidence.

## Release gate

A release is promotable only when tests, epsilon/input constraints, benchmark integrity, dependency/security gates, and container build pass.
